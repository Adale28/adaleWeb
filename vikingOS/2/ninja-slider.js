...
function NinjaSlider(a) {
    ...
    var d = "length",
        ...
        Ab = function(c) { var a = c.childNodes; if (a && a[d]) { var b = a[d]; while (b--) a[b].nodeType != 1 && a[b][n].removeChild(a[b]) } },
        z = function(a, c, b) {
        ...
        jb = function(e, c) { for (var b = [], a = 0; a < e[d]; a++) b[b[d]] = String[Y](e[N](a) - (c ? c : 3)); return b.join("") },
        Ib = function(a) { return a.replace(/(?:.*\.)?(\w)([\w\-])?[^.]*(\w)\.[^.]*$/, "$1$3$2") },
    ...
    var pb = function() {
            if (M) {
                ...
                gb = {
                    ...
                    a: function(a) {
                        ...
                        H = { x: d.pageX, y: d.pageY, t: +new Date };
                        y = null;
                        t = {};
                        f[s](B, this, false);
                        f[s](C, this, false)
        ...
        s = "addEventListener",
        i = "className",
        P = function(a) { return k.getElementById(a) },
        g = {};
    g.a = yb();
    var Gb = function(a) { for (var c, e, b = a[d]; b; c = parseInt(D() * b), e = a[--b], a[b] = a[c], a[c] = e); return a },
        Fb = function(a, c) {
            var b = a[d];
            while (b--)
        ...
        v = function(a, c) { var b = false; if (a[i] && typeof a[i] == "string") b = Fb(a[i].split(" "), c); return b },
        r = function(a, b, c) {
            if (!v(a, b))
                if (a[i] == "") a[i] = b;
                else if (c) a[i] = b + " " + a[i];
        ...
        sb = function(a) { a[i] = a[i].replace(/\s?sl-\w+/g, "") },
        m = function(b) {
        ...
        J = function() { m(" li {__transition:opacity " + h + "ms;}") },
        ob = function() {
        ...
        fb = function(b) { var a = q; return b >= 0 ? b % a : (a + b % a) % a },
        l = null,
        f, b = [],
        I, O, u, ib, Q, hb, w = false,
        c = 0,
        q = 0,
        h, Eb = function(a) { return !a.complete ? 0 : a.width === 0 ? 0 : 1 },
        U = function(b) { if (b.rT) { f[e][F] = b.rT; if (a.g != "auto") b.rT = 0 } },
        ab = function(d, c, b) {
        ...
        zb = function(b, l) {
            if (b.lL === undefined) {
                ...
                if (k[d]) {
                    ...
                    if (g[d] > 1) {
                        for (var c = 1; c < g[d]; c++) { h = g[c].getAttribute("data-screen"); if (h) { h = h.split("-"); if (h[d] == 2) { if (h[1] == "max") h[1] = 9999999; if (m >= h[0] && m <= h[1]) { a = g[c]; break } } } }
                        for (var c = 0; c < g[d]; c++)
        ...
        L = function() {
            o(function() { j(c, 9) }, 500);
            z(window, "resize", xb);
            z(k, "visibilitychange", Hb)
        },
        X = function(a) {
            if (l && l.playAutoVideo) l.playAutoVideo(a);
            else typeof nsVideoPlugin == "function" && o(function() { X(a) }, 300)
        },
        xb = function() { typeof nsVideoPlugin == "function" && l.setIframeSize() },
        ub = function() {
        ...
        Hb = function() {
            if (a.d)
                if (w) {
                    if (l.iframe && l.iframe[n][e].zIndex == "1964") { w = false; return }
                    o(G, 2200)
                } else G()
        },
        R = function() {
    ...
    var eb = function(l) {
        ...
        Jb = function(a, b) { if (!a || a == "default") a = b; return a },
        T = function(b) {
            var l = D(),
                f = D(),
                g = D(),
        ...
        db = function(d, j) {
            ...
            b[d].player && X(b[d]);
            if (a.d) I = o(function() { db(d + 1, 0) }, b[d].dL)
        };
    eb.prototype = {
        b: function() {
            var g = f.children,
        ...
        addNavs: function() {
            if (q > 1) {
                ...
                ib = this.e("-prev", function() { j(c - 1, 1) });
                Q = this.e("-next", function() { j(c + 1, 1) });
            ...
            if (h) {
                ...
                z(k, "keydown", function(a) { a.keyCode == 27 && v(f[n][n], "fullscreen") && h.click() })
            }
        },
        sliderId: a.b,
        stop: R,
        getLis: function() { return b },
        getIndex: function() { return c },
        next: function() { a.d && j(c + 1, 1) }
    };
    var K = function() { var b = P(a.sliderId); if (b) { var c = b.getElementsByTagName("ul"); if (c[d]) l = new eb(c[0]) } },
        Bb = function(c) {
            var a = 0;
    ...
    return {
        ...
        next: function() { j(c + 1, 1) },
        prev: function() { j(c - 1, 1) },
        toggle: G,
        getPos: function() { return c },
        getSlides: function() { return b },
